  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    ...
    <div class="col-5 h-100  bg-gradient-light">
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-lg-12 card-outline card-blue rounded-0 shadow">
          ...
          <div class="card-body rounded-0">
            <form id="register-frm" action="" method="post">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-4">
                  <button type="submit" class="btn btn-default bg-gradient-blue border-0 btn-block btn-flat">Create Account</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
